...
const releaseNotes = read("docs/release-notes/SwarmSim-Strategy-Autobuyer-0.13.0-release-notes.md");
...
if (failures.length) {
  console.error(`FAIL check-0.13.0-version-surfaces: ${failures.join("; ")}`);
  process.exit(1);
}

console.log("PASS check-0.13.0-version-surfaces");
