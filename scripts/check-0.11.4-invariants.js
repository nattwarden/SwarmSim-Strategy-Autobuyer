...
requirePattern(/const\s+AUTOBUYER_VERSION\s*=\s*"0\.11\.5"/, "Invariant failed: canonical runtime version must be 0.11.5.");
requirePattern(/const\s+SCENARIO_REPORT_VERSION\s*=\s*AUTOBUYER_VERSION/, "Invariant failed: scenario report version must derive from canonical runtime version.");
