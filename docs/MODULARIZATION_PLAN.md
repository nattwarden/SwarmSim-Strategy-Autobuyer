...
4. Phase 4 (in progress): config-driven build/check assembly added for canonical userscript with multi-source part support; next step is wiring lane sources into the assembly.
