...
4. [Strategy Audit 0 - Early-Game Behavioral Baseline](STRATEGY_AUDIT_0_EARLY_GAME.md)
5. [Strategy Audit Result Schema](STRATEGY_AUDIT_RESULT_SCHEMA.md)
6. [Testbed Feasibility Work Order](../prompts/next-strategy-audit-testbed-feasibility.md)
7. [Testbed Implementation Work Order](../prompts/next-strategy-audit-testbed-implementation.md)
8. [Strategy Audit 0 Work Order](../prompts/next-strategy-audit-0-early-game.md)
